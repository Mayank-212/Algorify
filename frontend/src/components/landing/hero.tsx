...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 pt-20">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-accent-purple/10 rounded-full " />
      <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-accent-blue/10 rounded-full " />
